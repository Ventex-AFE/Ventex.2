...
$Id_prod = mysqli_real_escape_string($Conexion_usser_changes, $_POST['id_prodr']);
...
$sentence = "INSERT INTO reportes_producto (ID_Usuario,ID_Producto, Motivo, Fecha, Hora) 
