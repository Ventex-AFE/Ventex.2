...
<head>
    ...
    <link rel="stylesheet" href="../Styles/Styles-pago-Suscripcion.css">
</head>
<body>
  <main>
...
<rect fill="white" height="38.1" width="80"></rect>
  ...
  <div class="separator">
    <hr class="line">
    <p style="color:   rgb(52, 96, 52);">O paga usando targeta de credito</p>
    <hr class="line">
  </div>
...
<footer>
                <section id="aviso">
                    <span id="av">
                        Ventex no realiza activamente llamadas para ofrecer/vender vacaciones. Tampoco pide a través de SMS o de las redes sociales datos bancarios, tarjetas de crédito, clave NIP, <br>
                ...
                <section id="redes">
                    <a href="https://www.youtube.com/watch?v=0lapF4DQPKQ" target="_blank" rel="noopener noreferrer"><img src="../Icons/instagram.png" class="ic"></a>
                    <a href="https://twitter.com/bts_bighit?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" rel="noopener noreferrer"><img src="../Icons/x.png" class="ic"></a>
                    <a href="https://www.facebook.com/share/v/vE8F3jJBMivuGgHa/?mibextid=WC7FNe" target="_blank" rel="noopener noreferrer"><img src="../Icons/whatsapp.png" class="ic"></a>
